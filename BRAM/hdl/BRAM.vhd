...
architecture STRUCTURE of BRAM is
  ...
  signal BRAM_PORTB_1_ADDR : STD_LOGIC_VECTOR ( 2 downto 0 );
...
begin
  ...
  BRAM_PORTB_1_ADDR(2 downto 0) <= BRAM_PORTB_addr(2 downto 0);
...
blk_mem_gen_0: component BRAM_blk_mem_gen_0_0
     port map (
      ...
      addrb(2 downto 0) => BRAM_PORTB_1_ADDR(2 downto 0),
